  ...
  if (isset($_GET['id'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='kabupaten.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='kabupaten.php';</script>";
  }         
  ?>
<!DOCTYPE html>
<html>
...
<div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Edit KABUPATEN <?php echo $data['nama_kelas']; ?></h1>
          ...
          <div class="section-body bg-primary">
            ...
            <p class="section-lead">Edit KABUPATEN Disini</p>
          <div class="row">
              <div class="col-12">
                <div class="card">
                      ...
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">Rubah KABUPATEN<i class="fas fa-arrow-right"></i></button>>
                          </div>
                        </div>
                      </div>
                    </form>
