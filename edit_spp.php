...
<div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Edit PEMESANAN <?php echo $data['tahun']; ?></h1>
                      ...
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">Rubah PEMESANAN<i class="fas fa-arrow-right"></i></button>>
                          </div>
                        </div>
                      </div>
                    </form>
